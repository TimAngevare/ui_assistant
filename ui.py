...
temp = tk.Label(temp_holder, fg=gray, text="temp", font=("Impact", 22), bg=yellow)
...
btc = tk.Label(btc_holder, fg=gray, text="btc", font=("Impact", 22), bg=yellow)
...
def update():
    temp.config(text = "Degrees room \n Degrees outside: " + str(webscraper.weather()) + '\n' + str(datetime.now()))
